class Portafolio:
    def __init__(self, id_usuario: int, id_accion: int, id_cotizacion: int, cantidad_acciones: int, valor_comprometido: float, rendimiento_operacion: float, id_portafolio: int = None):
